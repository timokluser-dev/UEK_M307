$.fn.pageMe = function(opts) {
    ...
    var numItems = children.length; // ! `.lenght` needed

    // * CUSTOMIZATION: Display ALL
    if (settings.perPage == 0) settings.perPage = numItems;
    perPage = settings.perPage;
    // * END

    var numPages = Math.ceil(numItems / perPage);

    $("#total_reg").html("Total: " + numItems + " Records");
